...
{
    //references for game board to scale and house the puzzle
    ...
    //Create the game set up with x size pieces
    ...
    //We name the pieces in order to use this to check completion
